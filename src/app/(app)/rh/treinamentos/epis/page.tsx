  ...
  return (
    <div>
      ...
      <div className="mb-6 mt-1 flex items-center justify-between">
        <div>
          <h1 className="text-xl font-semibold text-neutral-900">EPIs</h1>
          <p className="mt-1 text-sm text-neutral-500">
            {issuances.length} {issuances.length === 1 ? "entrega registrada" : "entregas registradas"}
          </p>
        </div>
        <Link
            ...
            {issuances.length === 0 && (
              <tr>
                <td colSpan={5} className="px-4 py-10 text-center text-sm text-neutral-400">
                  Nenhuma entrega de EPI cadastrada ainda.
                </td>
              </tr>
            )}
            {issuances.map((i) => {
              ...
              return (
                <tr key={i.id} className="border-b border-neutral-100 last:border-0 hover:bg-neutral-50">
                  ...
                  <td className="px-4 py-3 text-neutral-700">{formatDate(i.issueDate)}</td>
