...
import { updatePiqueteBoundaryAction } from "../actions";
...
export function PiqueteBoundarySection({
  piqueteId,
  boundary,
}: {
  piqueteId: string;
      ...
      <PolygonEditor
        ...
        onSave={(geoJson, areaHa) => {
          ...
          startTransition(async () => {
            await updatePiqueteBoundaryAction(piqueteId, geoJson as Prisma.InputJsonValue, areaHa);
            setSaved(true);
          });
        }}
      />
