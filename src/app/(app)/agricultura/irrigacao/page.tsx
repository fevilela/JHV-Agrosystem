  ...
  return (
    <div>
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h1 className="text-xl font-semibold text-neutral-900">Irrigação</h1>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-neutral-200 bg-neutral-50 text-left text-xs font-medium uppercase tracking-wide text-neutral-500">
              ...
              <th className="px-4 py-3">Horas de Bomba</th>
          ...
          <tbody>
            ...
            {records.map((r) => (
              <tr key={r.id} className="border-b border-neutral-100 last:border-0 hover:bg-neutral-50">
                ...
                <td className="px-4 py-3 text-neutral-700">{r.consumoM3 ? `${r.consumoM3} m³` : "—"}</td>
                <td className="px-4 py-3 text-neutral-700">{r.horasBomba ? `${r.horasBomba} h` : "—"}</td>
