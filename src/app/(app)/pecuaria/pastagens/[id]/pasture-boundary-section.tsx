...
import { updatePastureBoundaryAction } from "../actions";
...
export function PastureBoundarySection({
  pastureId,
  boundary,
}: {
  pastureId: string;
      ...
      <PolygonEditor
        ...
        onSave={(geoJson, areaHa) => {
          ...
          startTransition(async () => {
            await updatePastureBoundaryAction(pastureId, geoJson as Prisma.InputJsonValue, areaHa);
            setSaved(true);
          });
        }}
      />
