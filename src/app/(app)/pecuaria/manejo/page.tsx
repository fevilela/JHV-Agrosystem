...
import { managementMovementTypeLabels, formatCurrency, formatDate } from "@/lib/labels";
  ...
  return (
    <div>
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h1 className="text-xl font-semibold text-neutral-900">Manejo</h1>
              ...
              <tr key={m.id} className="border-b border-neutral-100 last:border-0 hover:bg-neutral-50">
                ...
                <td className="px-4 py-3">
                  <span className={`rounded-full px-2 py-0.5 text-xs font-medium ${typeColor[m.type]}`}>
                    {managementMovementTypeLabels[m.type]}
                  </span>
                </td>
                ...
                <td className="px-4 py-3 text-neutral-700">{formatCurrency(m.value)}</td>
                <td className="px-4 py-3">
